    ...
    <div className="flex flex-col h-full flex-1 min-h-0">
      ...
      <div className="px-6 py-3 border-b border-tv-border-divider shrink-0">
        <div className="flex items-center gap-2 bg-tv-surface rounded-full px-3.5 py-2 border border-tv-border-light max-w-sm">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search your videos&hellip;" className="bg-transparent text-[12px] outline-none flex-1 placeholder:text-tv-text-secondary" />
        </div>
      </div>
