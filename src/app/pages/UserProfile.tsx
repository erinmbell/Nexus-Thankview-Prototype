    ...
    <Box p={{ base: "sm", sm: "xl" }} pt={0} maw={672}>
      ...
      <div className="border rounded-[var(--mantine-radius-default)] p-4 sm:p-6 mb-4" style={{ borderColor: TV.borderLight }}>
        ...
        <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md" mb="md">
          <TextInput label="First Name" autoComplete="given-name" required value={firstName} onChange={e => setFirstName(e.currentTarget.value)} />
          <TextInput label="Last Name" autoComplete="family-name" required value={lastName} onChange={e => setLastName(e.currentTarget.value)} />
        </SimpleGrid>
        <Select
