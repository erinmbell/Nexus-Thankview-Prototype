...
function RecentlyUsedSidebar({ lists, onSelect }: { lists: ContactList[]; onSelect: (l: ContactList) => void }) {
  ...
  return (
    <div className="rounded-[12px] border p-4" style={{ borderColor: TV.borderStrong, minWidth: 220, maxWidth: 260, flexShrink: 0, alignSelf: "flex-start", position: "sticky", top: 24 }}>
...
function ListDetail({ list, onBack, onManage, isOwner }: {
  ...
  return (
    <Box>
      ...
      <div className="rounded-[20px] border" style={{ borderColor: TV.borderStrong, overflow: "hidden" }}>
