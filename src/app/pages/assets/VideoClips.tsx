...
const ITEMS: IntroOutroItem[] = [
  ...
  { id: 103, kind: "outro", name: "Scholarship Impact End",         bgColor: "#0090bb", ctaLabel: "Support Scholarships", ctaUrl: "https://hartwell.edu/scholarships", outroMusic: "Upbeat Ending", gradient: "from-[#0090bb] to-[#00C0F5]", backgroundImage: "https://images.unsplash.com/photo-1655720359248-eeace8c709c5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkb25hdGlvbiUyMGNoYXJpdHklMjBnaXZpbmclMjBoYW5kc3xlbnwxfHx8fDE3NzE5ODM4MDR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral", duration: "0:15", isTemplate: false, updated: "Feb 14, 2026", used: 9, starred: false },
  { id: 104, kind: "outro", name: "Give Now — Green CTA",           bgColor: "#0e8a45", ctaLabel: "Give Now",             ctaUrl: "https://hartwell.edu/give",       outroMusic: "None",           gradient: "from-[#0e8a45] to-[#16b364]", backgroundImage: "", duration: "0:10", isTemplate: false, updated: "Feb 10, 2026", used: 15, starred: false },
    ...
    <div className="p-4 md:p-8 pt-0 min-h-full">
      ...
      <div className="flex flex-col gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 bg-white rounded-full px-4 py-1.5 border border-tv-border-light min-w-[200px] w-[255px] shrink-0">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search intros & outros…" aria-label="Search intros and outros" className="bg-transparent text-[13px] text-tv-text-primary outline-none w-full placeholder:text-tv-text-secondary focus-visible:outline-none" />
          {search && (
