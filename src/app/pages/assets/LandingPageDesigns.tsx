    ...
    <div className="p-4 md:p-8 pt-0 min-h-full">
      ...
      <div className="flex flex-col gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 bg-white rounded-full px-4 py-1.5 border border-tv-border-light max-w-[255px]">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search landing pages…" aria-label="Search landing pages" className="bg-transparent text-[13px] text-tv-text-primary outline-none w-full placeholder:text-tv-text-secondary focus-visible:outline-none" />
          {search && (
